...
sed -e "s|^ *\"rawPreferencesSourceUrl\": .*$|\"rawPreferencesSourceUrl\": \"http://${COUCHDB_HOST_ADDRESS}:5984/preferences/%userToken\"|" -i /opt/universal/gpii/node_modules/rawPreferencesServer/configs/production.json
